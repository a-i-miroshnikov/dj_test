# Generated by Django 4.0.5 on 2022-07-03 10:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model1')),
                ('model8', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model8')),
            ],
        ),
        migrations.CreateModel(
            name='Model9',
            fields=[
                ...
                ('result', models.FloatField(blank=True)),
                ('args', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model9args')),
                ('csv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.csvdata')),
            ],
        ),
        migrations.CreateModel(
            name='Model8Args',
            fields=[
                ...
                ('D12top_average', models.BooleanField(default=False)),
                ('model1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model1')),
                ('model2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model2')),
                ('model7', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model7')),
            ],
        ),
        migrations.AddField(
            model_name='model8',
            name='args',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model8args'),
        ),
        migrations.AddField(
            model_name='model8',
            name='csv',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.csvdata'),
        ),
        migrations.AddField(
            model_name='model7',
            name='args',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model7args'),
        ),
        migrations.AddField(
            model_name='model7',
            name='csv',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('L_wr', models.FloatField()),
                ('z', models.FloatField()),
                ('model4', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model4')),
            ],
        ),
        migrations.CreateModel(
            name='Model6',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.FloatField(blank=True)),
                ('args', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model6args')),
                ('csv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.csvdata')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.FloatField(blank=True)),
                ('args', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model5args')),
                ('csv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.csvdata')),
            ],
        ),
        migrations.AddField(
            model_name='model4',
            name='args',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model4args'),
        ),
        migrations.AddField(
            model_name='model4',
            name='csv',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.FloatField(blank=True)),
                ('args', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model3args')),
                ('csv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.csvdata')),
            ],
        ),
        migrations.AddField(
            model_name='model2',
            name='args',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model2args'),
        ),
        migrations.AddField(
            model_name='model2',
            name='csv',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.FloatField(blank=True)),
                ('args', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model10args')),
                ('csv', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.csvdata')),
            ],
        ),
        migrations.AddField(
            model_name='model1',
            name='args',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.model1args'),
        ),
        migrations.AddField(
            model_name='model1',
            name='csv',
